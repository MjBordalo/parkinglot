...
fn_yaml = r"../datasets/CUHKSquare2.yml"
fn_out = r"../datasets/output4.avi"
config = {'save_video': False,
          ...
          'min_area_motion_contour': 150, #150
          'park_laplacian_th': 5.7, #3.5 #video1 1.5 video2 6.5
          'park_sec_to_wait':  0.1,#5
          'start_frame': 0} #35000
...
for image in camera.capture_continuous(rawCapture, format="bgr", use_video_port=True):
	...
	frame = image.array
        video_cur_frame= video_cur_frame+1
        video_cur_pos = video_cur_frame
        ...
        if config['save_video']:
            if video_cur_frame % 1 == 0: # take every 30 frames
                out.write(frame_out)
