...
fn = r"../datasets/pl-trigger_edited.mp4"
fn_yaml = r"../datasets/pl-trigger_edited.yml"
fn_out = r"../datasets/pl-trigger_edited-out.avi"
...
config = {'save_video': True,
          ...
          'park_laplacian_th': 1.5, #3.5 #video1 1.5 video2 6.5
          'park_sec_to_wait':  1,#5
          'start_frame': 0} #35000
